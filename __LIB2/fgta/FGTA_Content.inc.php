...
class FGTA_Content extends FGTA_WebService
{
	...
	public function load_html_fgta_search($Search, $devform=false) {
		...
		if (defined('__USER_APPS_DIR'))
			if (is_file($this->ROOT_DIR . "/apps/" . __USER_APPS_DIR . "/" . $this->NS . "/" . $this->CL . ".layoutsearch.php"))
				$LAYOUTFILE = $this->ROOT_DIR . "/apps/".  __USER_APPS_DIR . "/" . $this->NS . "/" . $this->CL . ".layoutsearch.php";
