...
class Index extends FGTA_Request
{

	public function Show() {
		$fulladdress = (!empty($_SERVER['HTTPS']) ? 'https' : 'http') . '://' .$_SERVER["HTTP_HOST"] . $_SERVER['REQUEST_URI'];
		$elements = explode('/', $fulladdress);
	...
	public function SwitchToContainer() {
		echo "
		<script>
		var isMobile = false; //initiate as false

		// deteksi device apa yang digunakan
		...
		if (!isMobile)
			...
			location.href = \"container.mob.php\";
		</script>
